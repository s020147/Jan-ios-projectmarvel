    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading) {
                ForEach(viewModel.comicList, id: \.id) { item in
                    LazyVStack {
                        ...
                        .padding(7)
                        .onAppear(perform: {
                            if viewModel.shouldLoadMoreContent(currentComic: item),
...
struct ComicView_Previews: PreviewProvider {
    static var previews: some View {
        ComicView(destination:  "http://gateway.marvel.com/v1/public/characters/1009146/comics?ts=1&apikey=80927809fe13da055e5477a0996093c7&hash=f25bfb7addb67f49a3479a1baf232a01")
    }
}
